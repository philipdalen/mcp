...
func CompanyList(client *deskclient.Client) server.ServerTool {
	opts := []mcp.ToolOption{
		...
		mcp.WithArray("domains",
			mcp.Description("The domains of the company to filter by."),
	...
	return server.ServerTool{
		Tool: mcp.NewTool(string(MethodCompanyCreate),
			...
			mcp.WithString("description",
				mcp.Description("The description of the company."),
			),
			mcp.WithString("details",
				mcp.Description("The details of the company."),
			),
			mcp.WithString("industry",
				mcp.Description("The industry of the company."),
			),
			mcp.WithString("website",
				mcp.Description("The website of the company."),
			),
			mcp.WithString("permission",
				mcp.Description("The permission level of the company."),
				mcp.Enum("own", "all"),
			),
			mcp.WithString("kind",
				mcp.Description("The kind of the company."),
				mcp.Enum("company", "group"),
			),
			mcp.WithString("note",
				mcp.Description("The note for the company."),
			),
			mcp.WithArray("domains",
				mcp.Description("The domains for the company."),
				mcp.Items(map[string]any{
					"type": "string",
				}),
			),
